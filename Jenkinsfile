      ...
      steps {
        sh '''#! /bin/bash
              ...
              if [ "${NEW_PACKAGE_TAG}" != "${PACKAGE_TAG}" ]; then
                ...
                git pull https://${LS_USER}:${GITHUB_TOKEN}@github.com/${LS_USER}/${LS_REPO}.git main
                git push https://${LS_USER}:${GITHUB_TOKEN}@github.com/${LS_USER}/${LS_REPO}.git main
